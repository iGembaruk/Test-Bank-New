...
class AdminSteps(BaseSteps):
    def create_simple_user(self, create_user_request: CreateSimpleUserRequest):
    ...
    def create_credit_user(self, create_user_request: CreateCreditUserRequest):
        response = ValidateCrudRequester(
            request_spec=RequestSpecs.auth_headers(username="admin", password="123456"),
            endpoint=Endpoint.ADMIN_CREATE_USER,
            response_spec=ResponseSpecs.request_ok(),
    ...
    def create_invalid_user(self, create_user_request: CreateSimpleUserRequest):
        CrudRequester(
            request_spec=RequestSpecs.auth_headers(username="admin", password="123456"),
            endpoint=Endpoint.ADMIN_CREATE_USER,
